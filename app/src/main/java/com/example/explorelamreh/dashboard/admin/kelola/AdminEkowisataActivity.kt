...
class AdminEkowisataActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        binding.tvTitlePage.text = "Kelola Ekowisata"
        // Data Dummy
        dataList.add(Wisata("1", "Hutan Mangrove", "Lamreh", "Wisata alam hijau", "Ekowisata"))
    }
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Simpan") { _, _ ->
                ...
                if (nama.isNotEmpty() && lokasi.isNotEmpty()) {
                    if (existingItem == null) {
                        val newItem = Wisata(System.currentTimeMillis().toString(), nama, lokasi, deskripsi, "Ekowisata")
